...
export default function NavBar() {
	...
	if (!session)
		return <div className="skeleton bg-base-200 w-full px-10 h-16 shadow-sm rounded-box"></div>;
	...
	return (
		<div className="navbar bg-base-200 shadow-sm rounded-box px-10">
			...
			<div className="navbar-end flex gap-3">
				...
				<ul
					className="dropdown dropdown-center menu w-max rounded-box bg-base-100 shadow-sm mr-2 mt-2 "
					popover="auto"
					id="popover-1"
