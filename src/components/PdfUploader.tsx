...
import generateUploadSignature from "@/app/api/pdf/generatePdfUploadSignature";
...
export default function PdfUploader() {
  ...
  return (
    <>
      ...
      <input
        id="upload-book-input"
        type="file"
        className="file-input opacity-0 absolute"
